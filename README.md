...
## Benchmarking
The HERMES benchmarking code (data transfer latency, resource usage, realtime processing headroom, etc.) can be found in [the dedicated repository](https://github.com/maximyudayev/hermes-benchmark).
